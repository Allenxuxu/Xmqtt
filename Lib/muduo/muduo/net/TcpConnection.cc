...
void muduo::net::TcpConnection::enableCloseAfter(double delay)
{
    timerId_ = loop_->runAfter(delay, makeWeakCallback(shared_from_this(),
                                                       &TcpConnection::forceClose));
}

void TcpConnection::cancelCloseAfter()
{
